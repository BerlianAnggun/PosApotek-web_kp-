...
<div class="container  ">
        <h2 class="text-2xl font-bold text-center mb-6">Edit Obat</h2>
        ...
        <div class="mb-4">
            ...
            <input type="text" id="nama_produk" name="nama_produk" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" value="{{$row->nama_produk}}">
        </div>
        <div class="mb-4">
    ...
    <select name="jenis" id="jenis" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="harga" name="harga" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" value="{{$row->harga}}">
        </div>
        <div class="mb-4">
            <label for="stok" class="block text-sm font-semibold text-gray-700">Stok</label>
            <input type="number" id="stok" name="stok" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" value="{{$row->stok}}">
        </div>

        <!-- Password -->
        <div class="mb-4">
            <label for="deskripsi" class="block text-sm font-semibold text-gray-700">Deskripsi</label>
            <input type="text" id="deskripsi" name="deskripsi" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" value="{{$row->deskripsi}}">
        </div>
        <div class="mb-4">
    ...
    <select name="kategori_id" id="kategori_id" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
        <option value="{{$row->kategori_id}}">{{$row->warna}}({{$row->kategori->nama_kategori}})</option>
